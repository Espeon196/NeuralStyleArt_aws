...
def main(
    ...
    assert style_img.size() == content_img.size(), \
        "we nees to import style and content images of the same size"
    print("Done.")
...
if __name__ == '__main__':
    ...
    main(args.style, args.content, num_steps=args.num_steps, style_weight=args.style_weight,
        content_weight=args.content_weight, save_path=args.save_path, use_s3=args.use_s3)
